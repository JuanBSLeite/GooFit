...
/// Relativistic Breit-Wigner Rio

class RBW_Rio : public ResonancePdf {

  public:

    RBW_Rio(std::string name,
...
/// FLATTE constructor Rio

class FLATTE_Rio : public ResonancePdf {

  public:

    FLATTE_Rio(std::string name,
